...
//            fetchRequest.predicate = NSPredicate(format: "name = %@", self.chosenGene)
    ...
    @IBAction func tryButton(_ sender: Any) {
        ...
        momFirstTextField.text = "Black"
        dadFirstTextField.text = "Black"
        momsMomFirstTextField.text = "Black"
        momsDadFirstTextField.text = "Black"
        dadsMomFirstTextField.text = "Black"
        dadsDadFirstTextField.text = "Black"
        momsMomsMomFirstTextField.text = "Black"
        momsMomsDadFirstTextField.text = "Black"
        momsDadsMomFirstTextField.text = "Black"
        momsDadsDadFirstTextField.text = "Black"
        dadsMomsMomFirstTextField.text = "Black"
        dadsMomsDadFirstTextField.text = "Black"
        dadsDadsMomFirstTextField.text = "Black"
        dadsDadsDadFirstTextField.text = "Black"
        ...
        dadsDadsMomSecondTextField.text = "Black"
        ...
        dadsDadsMomThirdTextField.text = "Black"
