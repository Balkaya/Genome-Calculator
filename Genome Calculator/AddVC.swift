...
//            fetchRequest.predicate = NSPredicate(format: "name = %@", self.chosenGene)
    ...
    @IBAction func tryButton(_ sender: Any) {
        ...
        momsDadThidTextField.text = "Auburn"
        dadsMomFirstTextField.text = "Green"
        dadsMomSecondTextField.text = "Black"
        dadsMomThirdTextField.text = "Red"
        dadsDadFirstTextField.text = "Brown"
        dadsDadSecondTextField.text = "Brown"
        dadsDadThirdTextField.text = "Auburn"
        momsMomsMomFirstTextField.text = "D. Brown"
        momsMomsMomSecondTextField.text = "White"
        momsMomsMomThirdTextField.text = "Auburn"
        momsMomsDadFirstTextField.text = "Brown"
        momsMomsDadSecondTextField.text = "Brown"
        momsMomsDadThirdTextField.text = "Auburn"
        momsDadsMomFirstTextField.text = "Brown"
        ...
        momsDadsDadThirdTextField.text = "Auburn"
        dadsMomsMomFirstTextField.text = "Brown"
        dadsMomsMomSecondTextField.text = "Brown"
        dadsMomsMomThirdTextField.text = "Auburn"
        dadsMomsDadFirstTextField.text = "D. Brown"
        dadsMomsDadSecondTextField.text = "White"
        dadsMomsDadThirdTextField.text = "Auburn"
        dadsDadsMomFirstTextField.text = "Green"
        dadsDadsMomSecondTextField.text = "White"
        dadsDadsMomThirdTextField.text = "Auburn"
        dadsDadsDadFirstTextField.text = "Green"
        dadsDadsDadSecondTextField.text = "White"
        dadsDadsDadThirdTextField.text = "Auburn"
    }
}
