...
//            fetchRequest.predicate = NSPredicate(format: "name = %@", self.chosenGene)
    ...
    @IBAction func tryButton(_ sender: Any) {
        ...
        dadFirstTextField.text = "Green"
        momsMomFirstTextField.text = "Green"
        momsDadFirstTextField.text = "Green"
        dadsMomFirstTextField.text = "Green"
        dadsDadFirstTextField.text = "Green"
        momsMomsMomFirstTextField.text = "Green"
        momsMomsDadFirstTextField.text = "Green"
        momsDadsMomFirstTextField.text = "Green"
        momsDadsDadFirstTextField.text = "Green"
        dadsMomsMomFirstTextField.text = "Green"
        dadsMomsDadFirstTextField.text = "Green"
