...
//            fetchRequest.predicate = NSPredicate(format: "name = %@", self.chosenGene)
    ...
    @IBAction func tryButton(_ sender: Any) {
        ...
        momFirstTextField.text = "Blue"
        dadFirstTextField.text = "Blue"
        momsMomFirstTextField.text = "Blue"
        momsDadFirstTextField.text = "Blue"
        dadsMomFirstTextField.text = "Blue"
        dadsDadFirstTextField.text = "Blue"
        momsMomsMomFirstTextField.text = "Blue"
        momsMomsDadFirstTextField.text = "Hazel"
        momsDadsMomFirstTextField.text = "Hazel"
        momsDadsDadFirstTextField.text = "Hazel"
        dadsMomsMomFirstTextField.text = "Hazel"
        dadsMomsDadFirstTextField.text = "Hazel"
        dadsDadsMomFirstTextField.text = "Hazel"
        dadsDadsDadFirstTextField.text = "Hazel"
        
        momSecondTextField.text = "Black"
        dadSecondTextField.text = "Black"
        momsMomSecondTextField.text = "Black"
        momsDadSecondTextField.text = "Black"
        dadsMomSecondTextField.text = "Black"
        dadsDadSecondTextField.text = "Black"
        momsMomsMomSecondTextField.text = "Black"
        momsMomsDadSecondTextField.text = "Black"
        momsDadsMomSecondTextField.text = "Black"
        momsDadsDadSecondTextField.text = "Black"
        dadsMomsMomSecondTextField.text = "White"
        dadsMomsDadSecondTextField.text = "Black"
        dadsDadsMomSecondTextField.text = "White"
        dadsDadsDadSecondTextField.text = "Black"
        
        momThirdTextField.text = "Black"
        dadThirdTextField.text = "Black"
        momsMomThirdTextField.text = "Black"
        momsDadThidTextField.text = "Black"
        dadsMomThirdTextField.text = "Yellow"
        dadsDadThirdTextField.text = "Black"
        momsMomsMomThirdTextField.text = "Black"
        momsMomsDadThirdTextField.text = "Black"
        momsDadsMomThirdTextField.text = "Black"
        momsDadsDadThirdTextField.text = "Black"
        dadsMomsMomThirdTextField.text = "Black"
        dadsMomsDadThirdTextField.text = "Black"
        dadsDadsMomThirdTextField.text = "Yellow"
        dadsDadsDadThirdTextField.text = "Black"
    }
}
