...
class Trash: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    var chosenGene = ""
    ...
    let picker9 = UIPickerView()
    let picker10 = UIPickerView()
    let picker11 = UIPickerView()
    let picker12 = UIPickerView()
    let picker13 = UIPickerView()
    let picker14 = UIPickerView()
    let picker15 = UIPickerView()
    let picker16 = UIPickerView()
    let picker17 = UIPickerView()
    let picker18 = UIPickerView()
    let picker19 = UIPickerView()
    let picker20 = UIPickerView()
    let picker21 = UIPickerView()
    let picker22 = UIPickerView()
    let picker23 = UIPickerView()
    let picker24 = UIPickerView()
    let picker25 = UIPickerView()
    let picker26 = UIPickerView()
    let picker27 = UIPickerView()
    let picker28 = UIPickerView()
    let picker29 = UIPickerView()
    let picker30 = UIPickerView()
    let picker31 = UIPickerView()
    let picker32 = UIPickerView()
    let picker33 = UIPickerView()
    let picker34 = UIPickerView()
    let picker35 = UIPickerView()
    let picker36 = UIPickerView()
    let picker37 = UIPickerView()
    let picker38 = UIPickerView()
    let picker39 = UIPickerView()
    let picker40 = UIPickerView()
    let picker41 = UIPickerView()
    let picker42 = UIPickerView()
    let picker43 = UIPickerView()
    let picker44 = UIPickerView()
    let picker45 = UIPickerView()
    let picker46 = UIPickerView()
    let picker47 = UIPickerView()
    let picker48 = UIPickerView()
    let picker49 = UIPickerView()
    let picker50 = UIPickerView()
    let picker51 = UIPickerView()
    let picker52 = UIPickerView()
    let picker53 = UIPickerView()
    let picker54 = UIPickerView()
    let picker55 = UIPickerView()
    let picker56 = UIPickerView()
...
//            eyesTextField1.text = eyesColors[row]
//        } else if pickerView == picker2 {
//            skinTextField1.text = skinColors[row]
//        }
    }
